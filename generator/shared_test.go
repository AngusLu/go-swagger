...
func TestDefaultImports(t *testing.T) {
	for i, toPin := range []struct {
	...
	}{
		{
			...
			Opts:  &GenOpts{},
			Expected: map[string]string{
				"models": "github.com/AngusLu/go-swagger/generator/models",
			},
		},
		{
			...
			Expected: map[string]string{
				"ext":    "github.com/AngusLu/go-swagger/generator/ext",
				"models": "github.com/AngusLu/go-swagger/generator/models",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/AngusLu/go-swagger/generator/target/bespoke",
			},
		},
		{
		...
		// issue #2362
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/AngusLu/go-swagger/generator/target/bespoke",
				"auth":    "github.com/AngusLu/go-swagger/generator/auth",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"models": "github.com/AngusLu/go-swagger/generator/target/models",
				"auth":   "target/auth",
			},
		},
	} {
